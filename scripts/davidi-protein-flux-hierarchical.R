######
# This script analyzes data from E. coli protein abundances and corresponding fluxes.
# There are two main analyses:
# 1) Fitting a hierarchical Bayesian model to estimate correlation coefficients.
# 2) Examining variation in this correlation coefficient using protein level features using a separate Bayesian model
######
